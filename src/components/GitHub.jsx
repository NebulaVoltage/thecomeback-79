        ...
        <div className="editorial-card p-8 md:p-12">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            ...
            <div className="flex items-start gap-5">
              ...
              <div>
                <div className="mono text-xs text-white/40 mb-1 uppercase tracking-wider">
                  @NebulaVoltage
                </div>
                <h3 className="text-xl md:text-2xl font-semibold text-[#FAFAFA] mb-2 font-[Manrope]">
                  Shreehith Sai Vodapally on GitHub
                </h3>
                <p className="text-sm text-white/65 max-w-xl leading-relaxed font-normal">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-7 h-[42px] rounded-full bg-white text-black font-semibold text-xs tracking-wider uppercase hover:bg-neutral-200 transition-all duration-300 shrink-0"
            >

...
export default function Hero() {
  ...
  return (
    <section className="relative w-full h-[100svh] min-h-[700px] overflow-hidden bg-[#050505] select-none">
      ...
      {/* 1. CINEMATIC BACKGROUND VIDEO (z-0) */}
      <video
        ref={videoRef}
      ...
      {/* 2. DARK OVERLAY (z-1) - Preserves right side bright portal while making left side dark & clear */}
      <div 
        className="absolute inset-0 z-[1] pointer-events-none"
        style={{
          background: 'linear-gradient(90deg, rgba(5,5,5,0.88) 0%, rgba(5,5,5,0.7) 42%, rgba(5,5,5,0.2) 100%)'
        }}
      />
      {/* Top & Bottom Vignette */}
      <div 
        className="absolute inset-0 z-[1] pointer-events-none"
        style={{
          background: 'linear-gradient(180deg, rgba(5,5,5,0.6) 0%, rgba(5,5,5,0) 25%, rgba(5,5,5,0) 75%, rgba(5,5,5,0.95) 100%)'
        }}
      />

      {/* 3. HERO CONTENT (z-10) */}
      <div className="absolute left-[5vw] top-[22vh] md:top-[26vh] z-10 w-[90vw] md:w-[46vw] max-w-[620px] flex flex-col items-start text-left">
        ...
        <h1 
          ...
          style={{ fontSize: 'clamp(3rem, 5.2vw, 5.3rem)' }}
        >
          SHREEHITH SAI <br />
          VODAPALLY
        </h1>
        ...
        <p className="text-sm md:text-base text-[#a7a6a6] font-normal leading-relaxed max-w-[540px] mb-8 font-[Manrope]">
        ...
        <div className="flex flex-wrap items-center gap-4">
          <a
            href="#projects"
            className="inline-flex items-center justify-center px-7 h-[44px] rounded-full bg-white text-black font-extrabold text-xs tracking-wider uppercase hover:bg-neutral-200 transition-all duration-300 shadow-2xl"
          >
            VIEW MY WORK
          </a>
          <a
